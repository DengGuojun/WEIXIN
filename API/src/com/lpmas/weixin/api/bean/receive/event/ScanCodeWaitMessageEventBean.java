...
public class ScanCodeWaitMessageEventBean extends EventBaseBean {

	public ScanCodeWaitMessageEventBean() {
		super(ReceiveEventConfig.EVENT_SCAN_CODE_WAIT_MESSAGE);
	}
