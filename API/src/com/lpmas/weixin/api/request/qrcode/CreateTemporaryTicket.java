...
public class CreateTemporaryTicket extends WxRequestBase {
	private static Logger log = LoggerFactory.getLogger(CreateTemporaryTicket.class);
	...
	public WxResponseBaseBean execute(WxRequestBaseBean requestBean) {
		...
		try {
			CreateTemporaryTicketRequestBean bean = (CreateTemporaryTicketRequestBean) requestBean;
			...
			log.error("CreateTemporaryTicket Error:", e);
		}
		return responseBean;
	}
}
