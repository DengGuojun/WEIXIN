...
<%
	...
	ReceiveMessageBean bean=(ReceiveMessageBean)request.getAttribute("ReceiveMessageBean");
...
<body class="article_bg">
    <div class="article_tit">
		...
		<ul class="art_nav">
			<li><a href="WeixinReceiveMessageList.do?accountId=<%=accountId %>">微信公众号消息管理</a>&nbsp;>&nbsp;</li>
			<li><%=accountName %>&nbsp;>&nbsp;</li>
		</ul>
	</div>
