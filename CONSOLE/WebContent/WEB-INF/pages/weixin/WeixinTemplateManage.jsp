...
<%
	...
	WeixinPropertyConfigBean bean=(WeixinPropertyConfigBean)request.getAttribute("WeixinPropertyConfigBean");
	int propertyId = bean.getPropertyId();
%>
...
<body class="article_bg">
    <div class="article_tit">
		...
		<ul class="art_nav">
			<li><a href="WeixinTemplateList.do">微信公众号模板信息</a>&nbsp;>&nbsp;</li>
			<% if(propertyId > 0) {%>
			<li><%=bean.getPropertyKey1() %>&nbsp;>&nbsp;</li>
			<li>修改模板信息</li>
			<%}else{ %>
			<li>新建模板信息</li>
			<%}%>
...
<form action="WeixinTemplateManage.do" method="post" name="formData" id="formData" onsubmit="javascript:return checkForm('formData');">
		    ...
		    <p>
		      <em class="int_label"><span>*</span>模板编号：</em>
		      <input type="text" name="propertyKey1" id="propertyKey1" size="50" value="<%=bean.getPropertyKey1() %>" checkStr="模板编号;text;true;;100" />
			</p>
			<p>
		      <em class="int_label"><span>*</span>模板ID：</em>
		      <input type="text" name="propertyValue1" id="propertyValue1" size="50" value="<%=bean.getPropertyValue1() %>" checkStr="模板ID;text;true;;100" />
			</p>
			<p>
