...
import com.lpmas.weixin.console.dao.WeixinReceiveMessageDao;
...
public class WeixinReceiveMessageBusiness {
	...
	public PageResultBean<ReceiveMessageBean> getWeixinReceiveMessagePageList(Map<String, Object> condMap,
			PageBean pageBean) {
		WeixinReceiveMessageDao weixinReceiveMessageDao = new WeixinReceiveMessageDao();
		Map<String, Object> orderBy = new HashMap<String, Object>();
		orderBy.put("createTime", MongoDBConfig.SORT_ORDER_DESC);
		return weixinReceiveMessageDao.getWeixinReceiveMessagePageList(condMap, pageBean, orderBy);
	}

	public ReceiveMessageBean getWeixinReceiveMessageBeanByKey(String _id) {
		WeixinReceiveMessageDao weixinReceiveMessageDao = new WeixinReceiveMessageDao();
		return weixinReceiveMessageDao.getWeixinReceiveMessageBeanByKey(_id);
	}

	public Map<String, Object> getDisplayMapByMessageBean(int accountId, MessageBaseBean bean) {
		result.clear();
		// 处理字段名
