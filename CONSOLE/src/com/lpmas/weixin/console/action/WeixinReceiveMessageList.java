...
/**
 * Servlet implementation class WeixinReceiveMessageList
 */
@WebServlet("/weixin/WeixinReceiveMessageList.do")
public class WeixinReceiveMessageList extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public WeixinReceiveMessageList() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 查询数据库
		WeixinReceiveMessageBusiness receiveMessageBusiness = new WeixinReceiveMessageBusiness();
		PageResultBean<ReceiveMessageBean> result = receiveMessageBusiness.getWeixinReceiveMessagePageList(condMap,
				pageBean);
		...
		request.setAttribute("ReceiveMessageList", result.getRecordList());
		request.setAttribute("AdminUserHelper", adminUserHelper);
		RequestDispatcher rd = request.getRequestDispatcher(WeixinConsoleConfig.PAGE_PATH + "WeixinReceiveMessageList.jsp");
